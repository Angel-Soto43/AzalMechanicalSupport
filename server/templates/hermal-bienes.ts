...
export function generateHermalBienesTemplate(provider: any, quote: any, items: any[]) {
  ...
  // Nota: Usamos deliveryConditions para la Documentación porque es la variable que trae subpuntos (a, b, c...)
  ...
  if (quote.deliverySingle !== false && quote.deliverySingle !== "false") {
    tablaLugaresHtml = `
      <tr>
        ...
        <td style="border: 1px solid black; padding: 4px; text-align: left;">${quote.deliveryLocation || quote.deliveryPlace || ""}</td>
      </tr>
    `;
  } else {
  ...
  return `
    ...
    <head>
      ...
      <style>
        ...
        body { 
          margin: 0; 
          padding: 140px 45px 0 45px; /* Padding-top obligatorio de 140px */
    ...
    <body>
         ...
         <!-- ENCABEZADO PRINCIPAL (Columnas 55% y 45%) -->
         <div style="display: flex; justify-content: space-between; margin-bottom: 30px;">
            ...
            <div style="width: 45%; text-align: right; display: flex; flex-direction: column; justify-content: flex-end; padding-top: 30px;">
         ...
         <ol class="roman-list">
            ...
            <li>Fecha de entrega: HERMAL Industrial, S.A. de C.V., realizará la entrega de los bienes requeridos y documentación completa a partir del siguiente día natural de la comunicación del fallo o notificación de la adjudicación y a más tardar el 
               ${deliveryDates.length > 0 ? `
                 <ul style="list-style-type: none; padding-left: 0; display: inline;">
                   ${deliveryDates.map((fecha: string) => ` ${fecha}`).join(', ')}
                 </ul>
               ` : ''}
            </li>
            ...
            <li>Mi representada cuenta con la capacidad técnica para el <b>suministro de los bienes</b> requeridos.</li>
